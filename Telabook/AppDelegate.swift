...
class AppDelegate: UIResponder, UIApplicationDelegate {
   ...
   func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplication.LaunchOptionsKey: Any]?) -> Bool {
      ...
      let apiKey:String = try! Configuration.value(for: .placesApiKey)
...
-H "Authorization: key=AAAAHQoUPqg:APA91bG0nkPPDHSeJDHgooGx24GVlfHpjZDraoLy-ivC5OAwvLD5sxx7KztNEcYt8Sl-dyGWU8Z1tVm7jZYfG5ZeopCOZc9A0F4AQVPinswTLjUEC5xNX4Nz_s7_7uJ-3ng-dh32TyVH" \
...
"registration_ids": [
"djvLGCfuK0Ybjmxvu061iN:APA91bH1yAjwEvJvkbRJ3fOkHFclBGhOgP0XNTZQywgJlggLWhwAYLWslngIuQHGw_Rbsa18SKdwm7WNey-ic7OG27eiRwDKC-E7__E2Mj4PiWCrqtLVTltXfrpfUQZEFaHlsMx2fhbI"
]
}'
*/

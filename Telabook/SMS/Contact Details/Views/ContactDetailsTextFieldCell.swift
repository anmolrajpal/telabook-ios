//
//  ContactDetailsTextFieldCell.swift
//  Telabook
//
...
class ContactDetailsTextFieldCell: UITableViewCell {
   ...
   private func layoutConstraints() {
      ...
      textField.anchor(top: containerView.topAnchor, left: containerView.leftAnchor, bottom: containerView.bottomAnchor, right: containerView.rightAnchor, topConstant: 0, leftConstant: 20, bottomConstant: 0, rightConstant: 20)
   }
}
